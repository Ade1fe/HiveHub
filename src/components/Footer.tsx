...
const Footer = () => {
  return (
    <Box mt={['60px', '70px', '80px', '90px']} mx='auto' mb='20px' px={[4,4,4,4,2,0]}  textAlign='center' display={['block','block', 'flex']} gap='4' justifyContent='space-between' alignItems='center' w='full'>
