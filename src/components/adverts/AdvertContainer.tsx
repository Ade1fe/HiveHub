...
const AdvertContainer = () => {
  ...
  return (
    <>
      {showAdvert && (
        <Box bg="#f1f1f1" pos='relative' top='0' zIndex='20' p={[2, 4]} borderRadius="md" boxShadow="md" textAlign="center" display='flex' flexDirection={["column", "row"]} alignItems='center' justifyContent='center' gap={[2, 4]} mx="auto" my={4} maxW="1340px" overflow="hidden">
