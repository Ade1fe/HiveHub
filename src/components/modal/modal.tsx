            ...
            <ModalBody pb={6} display='flex' flexDir='column' gap='35px' w='100%' alignItems='center' justifyContent='center' >
              ...
              <FormControl display='flex' flexDir='column' gap='20px' w='100%' alignItems='center' justifyContent='center'>
                ...
                <Box display='flex' flexDir='column' gap='15px' w={['100%', '80%']} mx='auto'>
                  {modalContext === 'signup' && (
                    <Input variant='outline' type='text' id='Username' placeholder='Your username' width={['100%', '80%']} margin='auto' textAlign='center' _hover={{ outline: 'none', border: 'none' }} _focus={{ outline: 'none', background: 'transparent', }} _focusWithin={{ outline: 'none', background: 'transparent', }} _active={{ outline: 'none', background: 'transparent', }} autoComplete="one-time-code" onChange={(e) => setFormData({ ...formData, username: e.target.value })} />
                  )}
                  <Input variant='outline' type='email' id='Email' placeholder='Your email' width={['100%', '80%']} margin='auto' textAlign='center' _hover={{ outline: 'none', border: 'none' }} _focus={{ outline: 'none', background: 'transparent', }} _focusWithin={{ outline: 'none', background: 'transparent', }} _active={{ outline: 'none', background: 'transparent', }} autoComplete="one-time-code" onChange={(e) => setFormData({ ...formData, email: e.target.value })} ></Input>
                  <InputGroup width={['100%', '80%']} display='flex' gap='2px' margin='auto' >
                    <Input variant='outline' type={showPassword ? 'text' : 'password'} id='Password' placeholder='Your password' w='100%'  textAlign='center' _hover={{ outline: 'none', border: 'none' }} _focus={{ outline: 'none', background: 'transparent' }} _autofill={{ outline: 'none', background: 'transparent' }} autoComplete="one-time-code" onChange={(e) => setFormData({ ...formData, password: e.target.value })} ></Input> 
