      ...
      <Tabs> 
        <TabList shadow='sm'>
          <Tab
            ...
            _selected={selectedCategory === 'All' ? { color: 'blue.500', borderBottomWidth: "2px" , borderBottomColor: "blue.500" } : undefined}
          >
            All
          </Tab>
          {Object.keys(data.reduce((acc, item) => ({...acc, [item.category]: true}), {})).map(category => (
            <Tab
              key={category}
              onClick={() => handleCategoryChange(category)}
              _selected={selectedCategory === category ? { color: 'blue.500', borderBottomWidth: "2px" , borderBottomColor: "blue.500" } : undefined}
