...
const LandingPage = () => {
  ...
  return (
    <Box display='flex' flexDir='column' w='100%' alignItems='center' justifyContent='center' gap={['20px', '30px']}>
      ...
      <Box display='flex' flexDir={['column', 'row']} w={['100%', '95%']} marginX='auto' pos='relative' alignItems='center' justifyContent={['center', 'space-between']} px={['2%', '3%']} py={['2%', '7%']} gap={['40px', '60px']} >
        ...
        <motion.div initial={{ opacity: 1, y: -20, background: '#aec3b0' }} animate={{ opacity: 0.5, y: 0, background: '#ff206e' }} exit={{ opacity: 1, y: -20, background: '#ff1654' }} transition={{ type: 'tween', duration: 1.5, repeat: Infinity, repeatType: 'reverse', ease: 'easeInOut' }} className="ball1" ></motion.div>
        <motion.div initial={{ opacity: 1, x: -20, background: '#ff1654' }} animate={{ opacity: 0.5, x: 0, background: '#e6ebe0' }} exit={{ opacity: 1, x: -20, background: '#6d2e46' }} transition={{ type: 'tween', duration: 1.5, repeat: Infinity, repeatType: 'reverse', ease: 'easeInOut' }} className="ball2" ></motion.div>
        <motion.div initial={{ opacity: 1, y: -20, background: '#7ae582' }} animate={{ opacity: 0.5, y: 0, background: '#9db4c0' }} exit={{ opacity: 1, y: -20, background: '#fbff12' }} transition={{ type: 'tween', duration: 1.5, repeat: Infinity, repeatType: 'reverse', ease: 'easeInOut' }} className="ball3" ></motion.div>
        ...
        <motion.div initial={{ opacity: 1, y: -20, background: '#e5989b' }} animate={{ opacity: 0.5, y: 0, background: '#affc41' }} exit={{ opacity: 1, y: -20, background: '#ff1654' }} transition={{ type: 'tween', duration: 1.5, repeat: Infinity, repeatType: 'reverse', ease: 'easeInOut' }} className="ball4" ></motion.div>
